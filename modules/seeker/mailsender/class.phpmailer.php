...
class PHPMailer
{
    ...
    public function __construct($exceptions = false)
    {
		...
		$this->Username = 'support@led.ru';                 // SMTP username                         // SMTP password
		$this->From = 'support@led.ru';
		$this->Password = '1478963';  
		
		$this->FromName = 'Информационная «База клиентов»';
		...
		$this->Port = 465;                                  // Set email format to HTML
