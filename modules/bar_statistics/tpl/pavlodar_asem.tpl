...
<h2><img alt="" src="/tpl/img/new/icon/bar_red.png">Склад Павлодар Асем за <?=$_GET['cdate'];?></h2>
<br>
<div class="row tabs">
	<div class="obj">
  ...
  <? } ?>
	...
	<div class="obj">
		<h1 class="active"><a href="/bar_statistics/pavlodar_asem/?year=<?=date('Y')?>&month=<?=date('m')?>">Павлодар Асем</a></h1>
	</div>
</div>
 ...
 <div class="white">
	 <table class="price2">
		<tbody>
		 ...
		 <tr>
			 <td class="right"><strong>УУ Продажи со склада Павлодар Асем</strong></td>
		 ...
		 <tr>
			 <td class="right"><strong>БУ Продажи со склада Павлодар Асем</strong></td>
...
<br>
	<div class="col-md-12">
		<form method="get" class="redirect" action="/bar_statistics/pavlodar_asem/">
			Выберите год:
...
$(document).on('click','form.redirect button.btn.reject',function(e)
{
	...
	document.location.href = "/bar_statistics/pavlodar_asem/?year=" + year + "&month=" + month;
