...
function DHTMLgoodies_formTooltip()
{
	...
	this.tooltipBgColor = '#CE1053';
	this.closeMessage = 'Закрыть';
	this.disableTooltipMessage = 'Не показывать больше подсказки';
	this.activeInput = false;
	this.tooltipPosition = 'right';
	this.arrowRightWidth = 7;			// Default width of arrow when the tooltip is on the right side of the inputs.
